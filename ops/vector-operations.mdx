...
```python
encrypted = sdk.vector.encrypt(vector_data)
```
...
```python
decrypted = sdk.vector.decrypt(encrypted_vector)
```
...
encrypted_vectors = sdk.vector.batch_encrypt(vectors)
```
...
# 2. Encrypt vector
encrypted = sdk.vector.encrypt(data)
